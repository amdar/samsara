...
if __name__ == "__main__":
	...
	while(True):
		...
		velocity_x = 0
		velocity_y = 0
		if input == io.KEY_RIGHT or input == ord('u') or input == ord('l') or input == ord('n'):
			velocity_x = 1
		elif input == io.KEY_LEFT or input == ord('y') or input == ord('h') or input == ord('b'):
			velocity_x = -1
		if input == io.KEY_DOWN or input == ord('j') or input == ord('b') or input == ord('n'):
			velocity_y = 1
		elif input == io.KEY_UP or input == ord('k') or input == ord('y') or input == ord('u'):
			velocity_y = -1
		...
		# camera
		console_size_y, console_size_x = io.screen.getmaxyx()
